...
const BentoTilt = ({children, className= ""}) => {
	...
	const handleMouseMove = (e) => {
		...
		const positionX = (e.clientX - left) / width;
		const positionY = (e.clientY - top) / height;

		const tiltX = (positionX - 0.5) * 10;
		const tiltY = (positionY - 0.5) * -10;
    ...
    <section className="bg-black pb-52">
			<div className="container mx-auto px-3 md:px-10">
				...
				<p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
					Immer yourself in a rich and ever-expanding universe where a vibrant array
					of products converge into an interconnected overlay experience 
					on your world.
				</p>
				</div>
			...
			rounded-md md:h-[65vh]">
				<BentoCard 
				  src="videos/feature-1.mp4"
					title={<>radia<b>n</b>t</>}
					description="A cross-platform metagame app, turning your acitivities across
